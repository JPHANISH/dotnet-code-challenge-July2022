...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        public void GetEmployeeById_Returns_Ok()
        {
            ...
            var expectedDirectReportCounts = 2;
            ...
            Assert.AreEqual(expectedDirectReportCounts, employee.DirectReports.Count);
        }
        ...
        public void GetReportingStructureById_Returns_Ok()
        {
            ...
            var expectedFirstName = "John";
            var expectedLastName = "Lennon";
            var expectedReportStructureCount = 5;
            ...
            Assert.AreEqual(expectedReportStructureCount, reportingStructure.NumberOfReports);
        }
        ...
        [TestMethod]
        public void GetCompensationByEmployee_Returns_Ok()
        {
            // Arrange
            var employeeId = "16a596ae-edd3-4847-99fe-c4518e82c86f";
            var salary = 200000;
